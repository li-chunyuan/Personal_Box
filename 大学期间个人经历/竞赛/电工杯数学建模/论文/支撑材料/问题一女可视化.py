...
# 类别统计条形图
category_labels = ['畜、禽、鱼、蛋类及制品', '蔬菜、菌藻、水果类', '植物油类', '谷、薯类', '奶、干豆、坚果、种子类及制品']
category_counts = [6, 6, 5, 4, 1]
...
labels = ['蛋白质 (g)', '脂肪 (g)', '碳水化合物 (g)', '钙 (mg)', '铁 (mg)', '锌 (mg)',
          '维生素A (µg)', '维生素B1 (mg)', '维生素B2 (mg)', '维生素C (mg)']
actual_values = [54.5775, 49.799, 170.369, 346.0, 8.56, 5.383, 402.5, 1.1615, 0.8145, 40.32]
recommended_values = [60, 80, 300, 800, 20, 7.5, 700, 1.2, 1.2, 100]
...
meal_energy_percentages = [22.050079, 45.735573, 32.214348]
...
amino_acid_scores = [78.83, 80.28, 92.90, 68.41, 71.47, 72.52, 74.58, 74.88]
...
rects = ax.bar(labels, [0, 68.41], color=['skyblue', 'lightgreen'])
