...
% ① 【最优先加载】语言与基础核心
% =============================================================
% 防御性加载 xcolor，防止后续宏包参数冲突
% 建议加上 table 选项支持表格彩色，svgnames 支持更多颜色名
...
% =============================================================
% \usepackage{xcolor} % 已在最前面加载，此处注释掉避免冲突
...
\usepackage{threeparttable} % 表格脚注支持
% 作用：在表格下方添加注释（tablenotes），支持自动对齐和调整宽度
% 用法：
% \begin{table}
%   \begin{threeparttable}
%     \begin{tabular}{...} ... \tnote{1} ... \end{tabular}
%     \begin{tablenotes}
%       \item[1] 这是脚注内容
%     \end{tablenotes}
%   \end{threeparttable}
