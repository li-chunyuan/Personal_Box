...
\usepackage{microtype}%微排版           注意：不同引擎与语言环境支持略有差异，但通常“开箱即用”
...
%⑤表格增强类
% =============================================================
\usepackage{booktabs}%表格横线      %\toprule  表示表格最上面的粗线%      \midrule  表示表头和内容之间的中线%     \bottomrule 表格底部的粗线
...
% =============================================================
%⑥超链接与智能引用类（加载顺序：cleveref 必须在 hyperref 之后）
% =============================================================
